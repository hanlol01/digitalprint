...
const envSchema = z.object({
  ...
  MANAGEMENT_SEED_USERNAME: z.string().optional(),
  MANAGEMENT_SEED_PASSWORD: z.string().optional(),
  ...
  STAFF_SEED_USERNAME: z.string().optional(),
  STAFF_SEED_PASSWORD: z.string().optional(),
